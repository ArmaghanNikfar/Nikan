...
import TestimonialImg02 from "@/public/images/Shatel_Logo.png";
import TestimonialImg03 from "@/public/images/team images/Amir.jpg";
import TestimonialImg04 from "@/public/images/Dr.Mofrad.png";
import TestimonialImg05 from "@/public/images/Salman.jpg";
import TestimonialImg06 from "@/public/images/testimonial-06.jpg";
import TestimonialImg07 from "@/public/images/Nehsat.jpg";
import TestimonialImg08 from "@/public/images/testimonial-08.jpg";
import TestimonialImg09 from "@/public/images/sabz.png";
...
const testimonials = [
 
  {
    ...
    name: "M. Ahmadi",
    company: "Shatel",
    link:'https://shatel.ir',
    content:
      "Development of in-house front-end projects for Shatel’s technical support unit, improving customer service workflows.",
    categories: [1, 2, 3],
  },
  {
    img: TestimonialImg03,
    clientImg: TestimonialImg03,
    name: "Dr. Amir Shoja",
    company: "Dr. Amir Shoja",
    link:'https://dramirshoja.ir',
    content:
      "Design and implementation of a personal website and online booking system for a general physician, with integrated video call consultation.",
    categories: [1, 2, 3],
  },
  {
    img: TestimonialImg04,
    clientImg: TestimonialImg04,
    name: "Dr. Mofrad Clinic",
    company: "Clinic",
    link:'http://drmofradclinic.ir/',
    content:
      "AI-powered system for patient question analysis, automated acceptance or rejection of appointments, and intelligent online booking with natural language understanding.",
    categories: [1, 3],
  },
{
  img: TestimonialImg05,
  clientImg: TestimonialImg05,
  name: "Salman Yar Mehrban Co",
  company: "Salman Yar Mehrban",
  link:'/',
  content:
    "Development and implementation of an intelligent accounting system with automated financial workflows and smart reporting features.",
  categories: [1, 3],
},

{
  img: TestimonialImg07,
  clientImg: TestimonialImg07,
  name: "Neshat",
  company: "Neshat Group",
  link: '/',
  content:
    "Design and development of a user interface for language classes, including BigBlueButton configuration and full setup of the online classroom platform.",
  categories: [1, 2, 4],
},

  {
    img: TestimonialImg09,
    clientImg: TestimonialImg09,
    name: "E. Nikfar",
    company: "Masir Sabz Nikan",
    link:'https://dramirshoja.ir',
    content:
      "Providing AI-powered intelligent solutions for software systems, enhancing automation and efficiency across company processes.",
    categories: [1, 3],
  },
];
            ...
            {testimonials.map((testimonial, index) => (
              <div key={index} className="group">
                <Testimonial testimonial={testimonial} category={category}>
                  ...
                  <a style={{color:'blueviolet'}} target="_blank" href={testimonial.link}>Visit Website</a>
                  </div>
                </Testimonial>
              </div>
            ))}
